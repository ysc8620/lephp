 ...
 * 
 * examples of usage :
 * $myPacker = new tools_jspacker($script, 62, true, false);
 * $packed = $myPacker->pack();
 * 
 * or
 * 
 * $myPacker = new tools_jspacker($script, 'Normal', true, false);
 * $packed = $myPacker->pack();
 * 
 * or (default values)
 * 
 * $myPacker = new tools_jspacker($script);
 * $packed = $myPacker->pack();
 * 
 * 
...
class tools_jspacker {
	...
	private function _bootStrap($packed, $keywords) {
		...
		$unpackPacker = new tools_jspacker($unpack, 0, false, true);
